...
class GiftedChat extends React.Component {
    ...
    renderMessages() {
        ...
        <MessageContainer {...messagesContainerProps} onScrolledToBottom={this.props.onScrolledToBottom} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef} isTyping={this.props.isTyping}/>
